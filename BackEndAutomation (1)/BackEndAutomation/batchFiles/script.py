...
dirlist is now a list containing the names (as strings) of all items in the current directory.

if(files[-3:] == "csv"):
Checks if the last three characters of the filename are "csv".
"""
